...
import { deleteFormDefinitionSection } from "../../../../DataAccess/FormDefinitionSections";

export function DeletePage({ formDefinitionId }) {
  ...
  const onDelete = async (values) => {
    ...
    setWorking(true);
    try {
      await deleteFormDefinitionSection(params);
      setWorking(false);
