...
import { COMEX } from "../Constants/COMEX_DATA";
...
async function findComexRecapById(parameters) {
  try {
    ...
    const data = COMEX.recapCreated.find(r => r.id === parameters.id);
...
export { createComexRecap, updateComexRecap, deleteComexRecap, findAllComexRecaps, findComexRecapById};
